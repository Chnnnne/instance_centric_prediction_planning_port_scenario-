...
def get_parser():
    ...
    parser.add_argument(
        '--dataset_dir', '-dd', default=f'/private/wangchen/instance_model/my/instance_model_data_my/', type=str,
    ...
    # parser.add_argument(
    # '--load_checkpoint', '-lc', default="/private/wangchen/instance_model/output/MODEL/2024-07-02 23:45:29_front(最新15w数据训练得到)/saved_models/MODEL_epoch_030.pt", type=str,
    # help="Load pre-trained model for testing or resume training. Specify "
    #         "the epoch to load or 'best' to load the best model. Default=None "
    #         "means do not load any model.")
    # parser.add_argument(
    # '--load_checkpoint', '-lc', default="/private/wangchen/instance_model/output/MODEL/2024-06-28 17:13:02_back/saved_models/MODEL_epoch_030.pt", type=str,
    # help="Load pre-trained model for testing or resume training. Specify "
    #         "the epoch to load or 'best' to load the best model. Default=None "
    #         "means do not load any model.")
...
def main_parser_for_evel():
    parser = get_parser()
    parsed_args = parser.parse_args([])
    # parsed_args.base_dir = "/private/wangchen/instance_model/output_test_latency"
    parsed_args.base_dir = "/private/wangchen/instance_model/my/output_eval"
    parsed_args.batch_size = 16
    parsed_args.train_part = "front" # 测试前半部分的pt用front 整体用joint
    parsed_args = check_and_add_additional_args(parsed_args)
